        ...
        <main class="main ">
            ...
            <div class="p-5 sm:p-5">
                ...
                <div class="bg-white rounded-lg shadow p-6">
                    <form id="sessionForm" action="{{ route('dashboard.storeSession') }}" method="POST">
                        @csrf
                        ...
                        <div class="grid gap-4 mb-4 sm:grid-cols-2">
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <textarea name="description" id="description" rows="4"
                                    ...
                                    placeholder="Décrivez brièvement la session..."></textarea>
                            </div>
    
                            <!-- Démarrer maintenant -->
                            <div class="sm:col-span-2 flex items-center mt-2">
                                <input id="demarrer" type="checkbox" name="demarrer"
                                    class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500">
                                <label for="demarrer" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                                    Démarrer maintenant
                                </label>
                            </div>
                        ...
                        <input type="submit" value="Enregistrer la session et les candidats"
            ...
            <div class="candidats grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 p-5 sm:p-5">
                ...
                <!-- Image -->
                    <div class="flex justify-center mb-6">
                        ...
                        class="w-24 h-24 rounded-full object-cover border-4 border-indigo-800 py-5 border-white shadow-lg"
                        alt="Photo de ">
                    </div>
